...
const Website = () => {
  return (
    <div>
      ...
      <section className="w-full sm:w-2/3 flex flex-col sm:flex-row mx-auto flex-wrap py-20 gap-10">
  <div className="flex flex-col sm:flex-row gap-10 sm:gap-20 border-b-[1px] pb-10 sm:pb-20">
    <div className="w-full sm:w-[350px] flex flex-col gap-5">
      ...
      <div className="text-gray-400 text-sm leading-[25px]">
        <li>
          <span className="text-[#0693e3]">Events Module:</span> Facility to post IPS events directly to website.
        </li>
        <li>
          <span className="text-[#0693e3]">Google / Facebook Login:</span> For enhanced security.
        </li>
        <li>
          <span className="text-[#0693e3]">Books & Publications:</span> A central database for all IPS publications.
        </li>
      </div>
    </div>
    <div className="w-full sm:w-[350px] flex flex-col gap-5">
      ...
      <div className="text-gray-400 text-sm leading-[25px]">
        <li>
          <span className="text-[#0693e3]">Reports Module:</span> Events report, Zonal reports.
        </li>
        <li>
          <span className="text-[#0693e3]">Online Booking:</span> Headquarters, Facilities, etc.
        </li>
        <li>
          <span className="text-[#0693e3]">Online Payments:</span> Registrations, book purchase.
        </li>
        <li>
          <span className="text-[#0693e3]">Protected Documents:</span> Minutes, AGBM etc
        </li>
      </div>
    </div>
    <div className="w-full sm:w-[350px] flex flex-col gap-5">
      ...
      <div className="text-gray-400 text-sm leading-[25px]">
        <li>
          <span className="text-[#0693e3]">Mobile app: </span>Android and iOS app for notifications.
        </li>
        <li>
          <span className="text-[#0693e3]">Events app: </span> Book tickets, upload program, do quizzes.
        </li>
        <li>
          <span className="text-[#0693e3]">Forum & Social Networking: </span>A private Facebook.
        </li>
      </div>
    </div>
  </div>
...
<section className="w-full sm:w-2/3 flex flex-col sm:flex-row mx-auto pb-20 gap-10">
  <div className="flex flex-col sm:flex-row gap-10 sm:gap-20">
    ...
    <div className="w-full sm:w-[550px] h-[270px] flex flex-col items-center text-gray-600">
      <div className="flex flex-col gap-5">
        ...
        <div>
          <h1 className="text-sm text-gray-400">Kindly log in to access the message box.</h1>
          <form action="" className="flex flex-col items-center text-sm mt-2">
            <input
              type="text"
              placeholder="Username or email"
              className="h-[25px] w-[200px] placeholder-text-gray-400 placeholder-text-sm mb-2"
            />
            <input
              type="password"
